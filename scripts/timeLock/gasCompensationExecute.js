...
/*
ENV=demo npx hardhat run scripts/timeLock/gasCompensationExecute.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/gasCompensationExecute.js --network bscTestnet
*/