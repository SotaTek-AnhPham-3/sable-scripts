...
async function main() {
    ...
    let tx = await Contract.connect(signer).execute(stabilityPoolAddress, value, DATA, zeroBytes, salt);
    await tx.wait();
...
/*
ENV=demo npx hardhat run scripts/timeLock/rewardPerBlockExecute.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/rewardPerBlockExecute.js --network bscTestnet
*/