...
async function main() {
    ...
    const DATA = iface.encodeFunctionData("setRedemptionFeeFloor", [NEW_REDEMPTION_FEE_FLOOR.toString()]);
...
/*
ENV=demo npx hardhat run scripts/timeLock/redemptionFeeFloorSchedule.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/redemptionFeeFloorSchedule.js --network bscTestnet
*/