...
/*
ENV=demo npx hardhat run scripts/timeLock/ccrSchedule.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/ccrSchedule.js --network bscTestnet
*/