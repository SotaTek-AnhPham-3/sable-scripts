...
async function main() {
    ...
    let tx = await Contract.connect(signer).scheduleBatch(targets, [0, 0], DATA, zeroBytes, salt, DELAY);
    await tx.wait();
...
/*
ENV=demo npx hardhat run scripts/timeLock/batchSchedule.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/batchSchedule.js --network bscTestnet
*/