...
async function main() {
    ...
    // Variables to change
    const DELAY = 11;
    let NEW_BORROWING_FEE_FLOOR = "0.5"; // %
...
/*
ENV=demo npx hardhat run scripts/timeLock/borrowingFeeFloorSchedule.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/borrowingFeeFloorSchedule.js --network bscTestnet
*/