...
/*
ENV=demo npx hardhat run scripts/timeLock/redemptionFeeFloorExecute.js --network bscTestnet
ENV=oracle npx hardhat run scripts/timeLock/redemptionFeeFloorExecute.js --network bscTestnet
*/